...
export const ROLE_NAV_ITEMS: Record<UserRole, string[]> = {
  admin: ['dashboard', 'campaigns', 'channels', 'analytics', 'heatmaps', 'ai-optimization', 'anomalies', 'benchmarking', 'storyteller', 'team', 'platform-accounts', 'admin-advertisers', 'admin-merchants', 'admin-fraud', 'admin-disputes', 'admin-commerce', 'admin-moderation', 'admin-loyalty', 'site-content', 'roles-access', 'messages', 'merchant', 'merchant-products', 'merchant-orders', 'outlets', 'profile', 'settings'],
