...
export const ROLE_NAV_ITEMS: Record<UserRole, string[]> = {
  admin: ['dashboard', 'campaigns', 'analytics', 'heatmaps', 'ai-optimization', 'anomalies', 'benchmarking', 'storyteller', 'team', 'platform-accounts', 'admin-advertisers', 'admin-moderation', 'admin-loyalty', 'site-content', 'messages', 'merchant', 'outlets', 'profile', 'settings'],
