...
const milestones = [
  { year: '2024', title: 'The Beginning', desc: 'SmartDeals founded with a mission to make advertising rewarding for everyone.' },
      ...
      <div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-gray-600 dark:text-slate-400 leading-relaxed mb-4">
                  SmartDeals was born from a simple idea: advertising doesn't have to be intrusive, and attention has real value. We created a two-sided platform that empowers advertisers with AI-driven campaign management while rewarding users who choose to engage with content that interests them.
                </p>
        ...
        <section className="relative py-20 bg-primary-600 text-white text-center overflow-hidden">
          <div className="relative max-w-3xl mx-auto px-4">
            <h2 className="text-3xl font-bold mb-4">Join the SmartDeals Community</h2>
