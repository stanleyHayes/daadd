      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose-container space-y-10">
          <p className="text-gray-600 dark:text-slate-300 leading-relaxed">
            Welcome to DAADD. These Terms of Service ("Terms") govern your access to and use of the DAADD platform, including our website, mobile applications, and all related services (collectively, the "Service"). By accessing or using the Service, you agree to be bound by these Terms.
          </p>
          ...
          <section id="acceptance">
            ...
            <p className="text-gray-600 dark:text-slate-300 leading-relaxed mb-4">
              By creating an account, accessing, or using DAADD, you confirm that you are at least 16 years of age, have the legal capacity to enter into a binding agreement, and agree to comply with these Terms and our Privacy Policy. If you are using DAADD on behalf of a company or organization, you represent that you have the authority to bind that entity to these Terms.
            </p>
            <p className="text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <section id="account-registration">
            ...
            <p className="text-gray-600 dark:text-slate-300 leading-relaxed mb-4">
              You must register for an account to access most features of DAADD. You agree to provide accurate, current, and complete information during registration and to keep your account information up to date. You are responsible for maintaining the confidentiality of your login credentials and for all activities that occur under your account.
            </p>
            <p className="text-gray-600 dark:text-slate-300 leading-relaxed">
              DAADD offers two account types: Advertiser accounts (for creating and managing ad campaigns) and User accounts (for browsing ads and earning rewards). Some features, including AI optimization, anomaly detection, and benchmarking, are available only to Advertiser accounts with the appropriate subscription tier.
            </p>
          </section>
          ...
          <section id="user-terms">
            ...
            <p className="text-gray-600 dark:text-slate-300 leading-relaxed mb-4">
              Users earn rewards by viewing and engaging with ads on the DAADD platform. Reward amounts are set by advertisers and displayed before engagement. Rewards are credited to your DAADD wallet upon verified engagement. Engagement must be genuine; automated viewing, scripts, or other inauthentic engagement methods will result in reward forfeiture and potential account termination.
            </p>
            <h3 className="text-base font-semibold text-gray-800 dark:text-slate-200 mb-2">Eligibility</h3>
            <p className="text-gray-600 dark:text-slate-300 leading-relaxed">
              To earn and redeem rewards, you must be at least 16 years old, have a verified account, and reside in a supported country. Reward payouts are subject to minimum balance requirements ($5.00 minimum) and may be processed via bank transfer, PayPal, or platform credit. DAADD reserves the right to withhold payouts pending fraud review.
            </p>
          </section>
          ...
          <section id="prohibited-activities">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-600 dark:text-slate-300">
              ...
              <li>Attempt to reverse-engineer, decompile, or access the source code of the DAADD platform.</li>
              <li>Interfere with or disrupt the platform, servers, or networks connected to DAADD.</li>
          ...
          <section id="intellectual-property">
            ...
            <p className="text-gray-600 dark:text-slate-300 leading-relaxed mb-4">
              The DAADD platform, including its design, features, code, analytics tools (heatmaps, anomaly detection, Ad Journey Storyteller), and branding, is the intellectual property of DAADD Inc. and is protected by copyright, trademark, and other intellectual property laws. You may not copy, modify, or distribute any part of the platform without our written consent.
            </p>
            <p className="text-gray-600 dark:text-slate-300 leading-relaxed">
              Advertisers retain ownership of their creative assets. By uploading content to DAADD, you grant us a non-exclusive, worldwide license to display, distribute, and analyze your creatives for the purpose of operating the Service and providing campaign analytics.
            </p>
          </section>
          ...
          <section id="payment-terms">
            ...
            <p className="text-gray-600 dark:text-slate-300 leading-relaxed">
              User reward payouts are processed within 5 business days of a withdrawal request. DAADD is not responsible for delays caused by third-party payment processors or banking institutions. Rewards are non-transferable and have no cash value until redeemed through the official payout process.
            </p>
          </section>
          ...
          <section id="limitation-of-liability">
            ...
            <p className="text-gray-600 dark:text-slate-300 leading-relaxed">
              Our total liability for any claim arising from or related to the Service shall not exceed the greater of (a) the amount you paid to DAADD in the 12 months preceding the claim, or (b) $100. The Service is provided "as is" without warranties of any kind, express or implied.
            </p>
          </section>
          ...
          <section id="termination">
            ...
            <p className="text-gray-600 dark:text-slate-300 leading-relaxed">
              DAADD may suspend or terminate your account at any time for violation of these Terms, suspected fraud, or at our discretion with 30 days' notice. Upon termination, your right to use the Service ceases immediately. Provisions that by their nature should survive (including intellectual property, limitation of liability, and governing law) will remain in effect.
            </p>
          </section>
