      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose-container space-y-10">
          <p className="text-gray-600 dark:text-slate-300 leading-relaxed">
            SmartDeals ("we", "our", or "us") operates an intelligent advertising platform that connects advertisers with engaged audiences and rewards users for their attention. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our platform, website, and mobile applications.
          </p>
          ...
          <section id="information-we-collect">
            ...
            <p className="text-gray-600 dark:text-slate-300 leading-relaxed mb-4">
              When you register for a SmartDeals account, we collect your name, email address, phone number (for age verification and two-factor authentication), and account type (advertiser or user). Advertisers additionally provide company name, billing address, and payment details.
            </p>
          ...
          <section id="how-we-use">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-600 dark:text-slate-300">
              <li>Operate and maintain the SmartDeals platform, including ad serving, reward distribution, and campaign management.</li>
          ...
          <section id="data-sharing">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-600 dark:text-slate-300">
              ...
              <li><strong>Legal Requirements:</strong> We may disclose information when required by law, subpoena, or government request, or to protect the rights and safety of SmartDeals, our users, or the public.</li>
          ...
          <section id="cookies-tracking">
            ...
            <p className="text-gray-600 dark:text-slate-300 leading-relaxed mb-4">
              SmartDeals uses cookies and similar tracking technologies to operate the platform and measure ad engagement. As an advertising platform, accurate engagement tracking is essential to our core service. We use:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-600 dark:text-slate-300">
          ...
          <section id="geographic-data">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-600 dark:text-slate-300">
              <li><strong>Contract Performance:</strong> Processing necessary to provide the SmartDeals service, deliver ads, and process rewards.</li>
          ...
          <section id="contact">
            ...
            <div className="bg-gray-50 dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 p-6 text-sm text-gray-600 dark:text-slate-300 space-y-1">
              ...
              <p>EU Representative: SmartDeals EU Ltd., Dublin, Ireland</p>
            </div>
          </section>
        </div>
      </div>
