...
export function CampaignsListPage() {
  ...
  const { canOr } = usePermissions();
  const canCreate = canOr(hasPermission(userRole, 'CAMPAIGN_CREATE'), 'campaigns', 'create');
  const canEdit = canOr(hasPermission(userRole, 'CAMPAIGN_EDIT'), 'campaigns', 'update');
  const canDelete = canOr(hasPermission(userRole, 'CAMPAIGN_DELETE'), 'campaigns', 'delete');
