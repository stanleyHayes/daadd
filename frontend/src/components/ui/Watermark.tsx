...
/**
 * Watermark overlays (the tiled "SmartAdDeals" pattern and the corner banners) were
 * removed per design request. These components are intentionally no-ops so the
 * existing call sites keep compiling and rendering nothing — no SmartAdDeals branding
