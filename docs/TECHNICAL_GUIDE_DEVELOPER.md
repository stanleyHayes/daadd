# SmartAdDeals — Technical Guide for Developers
...
For third-party integrations (your app requests access to user's SmartAdDeals account):

**Step 1: Redirect user to SmartAdDeals login**
...
If your backend needs to call SmartAdDeals API on behalf of your service (not a user):
...
Content-Type: application/json
X-SmartAdDeals-Signature: sha256=abcdef1234567890
X-SmartAdDeals-Timestamp: 1715953800
X-SmartAdDeals-Event: campaign.budget_threshold
...
### Common Use Case: Integrate SmartAdDeals into Your Dashboard

If you're building a dashboard tool and want to let users connect their SmartAdDeals accounts:

**Step 1: Register Your App**

Contact SmartAdDeals to get:
- `client_id`
- `client_secret`
- Approved redirect URIs

**Step 2: Send User to SmartAdDeals Login**

```javascript
// In your web app
function connectSmartAdDeals() {
...
On your thank-you page after a purchase, POST to SmartAdDeals:
...
<script>
  ...
  // Track a purchase
  SmartAdDealsPixel.track('camp_456', 'conversion', { value: 99.99 });
</script>
```
...
// Webhook secret from SmartAdDeals
...
2. Register it with SmartAdDeals: `POST /webhooks` with your test URL
