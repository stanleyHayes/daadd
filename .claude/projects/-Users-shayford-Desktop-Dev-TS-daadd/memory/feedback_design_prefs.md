...
description: User prefers Google Sans font, animations, and dark/light theme support
type: feedback
---

Use Google Sans font throughout the app (loaded from CDNFonts). Previously tried Inconsolata, then TTSquares, settled on Google Sans.
